...
This document tracks which companies participate in each sector and how sector representation evolves from TEG 2024 to TEG 2026.

**Data Quality Note:** All companies listed below are verified from official sources (techexpogujarat.com/exhibitors or company websites). The Emgage conflict is noted separately.

**Multi-Domain Companies:** Many companies operate across multiple technology domains (e.g., AI + Cloud, Software Dev + E-commerce, etc.). These companies are listed in each relevant sector with cross-references noted in the "Notes" column. The summary table reflects total sector participations, not unique company counts.

---

## Official Industry Sectors (TEG 2026 Target)

Based on the official TEG industries page, the event targets these 18 sectors:
...
*(Source: techexpogujarat.com/industries/)*

---

## Sector Mapping: 82 Verified Companies
...
## Summary: TEG 2024 Sector Participation

**Note:** Companies can appear in multiple sectors. The counts below reflect total sector participation, not unique company counts.

| Sector | Companies | Percentage |
|---|---|---|
| Software Development & IT Services | 30 | 36.1% |
| AI & Machine Learning | 12 | 14.5% |
| Cloud & Infrastructure | 8 | 9.6% |
| E-commerce & Retail Technology | 6 | 7.2% |
| Cross-Sector / Miscellaneous | 30 | 36.1% |
| Cybersecurity | 3 | 3.6% |
| Digital Marketing & SEO | 4 | 4.8% |
| Fintech | 4 | 4.8% |
| Data & Analytics | 3 | 3.6% |
| Enterprise Software (ERP/CRM/HRMS) | 4 | 4.8% |
| Healthcare/EdTech | 4 | 4.8% |
| Telecom & VoIP | 2 | 2.4% |
| HR Tech | 1 | 1.2% |
| IoT & Hardware | 1 | 1.2% |
| Manufacturing/Industrial | 1 | 1.2% |
| Energy & Power | 1 | 1.2% |
| Real Estate | 1 | 1.2% |
| Consulting | 1 | 1.2% |
| Startup & Innovation | TBD | TBD |

**Total Sector Participations:** 115 (83 unique companies, many in multiple sectors)

---

## TEG 2026 Confirmed Exhibitors by Sector

| Sector | Company | Booth |
|---|---|---|
| AI & Machine Learning | Eternal Web Pvt Ltd | A48–A55 |
| AI & Machine Learning | Perigeon | A144 |
...
## Emgage Conflict Documentation

**Issue:** The official techexpogujarat.com/exhibitors page links the "Emgage" logo to an unrelated US cybersecurity company's domain.

**Real Exhibitor (Likely):** Emgage is likely an Ahmedabad-based HRMS company (emgage.work), which is far more plausible by geography and sector.

**Status:** ⚠️ Flagged but not resolved. The official source links to the US company, so we cannot confirm the Indian HRMS company's participation. Both are documented in the exhibitor master table.

**Action Needed:** Verify with the TEG organizing team which Emgage entity actually exhibited at TEG 2024.

---

## Sector Growth Trajectory

**Note:** TEG 2024 counts reflect multi-domain participations (companies can appear in multiple sectors).

| Sector | TEG 2024 | TEG 2026 (Confirmed) | Growth |
|---|---|---|---|
| AI & Machine Learning | 12 | 3 | Growing |
| Software Development | 30 | 1 | Stable |
| Cloud & Infrastructure | 8 | 1 | Stable |
| E-commerce/Retail | 6 | 0 | TBD |
| Fintech | 4 | 0 | TBD |
| Cybersecurity | 3 | 0 | TBD |
| Digital Marketing & SEO | 4 | 0 | TBD |
| Data & Analytics | 3 | 0 | TBD |
| Enterprise Software | 4 | 2 | Growing |
| Healthcare/EdTech | 4 | 0 | TBD |
| All Other Sectors | 34 | 0 | TBD |
...
TEG is positioned as "Gujarat's Beacon of Rising Innovation & AI." AI companies get:
- Direct access to 15,000+ decision-makers seeking AI solutions
- The "Experience Zone" for live AI demonstrations
- Networking with VCs interested in AI startups
- Association with Gujarat's AI transformation narrative

### For Software Development & IT Services
The largest sector at TEG 2024 with 22 companies. Benefits include:
- Access to 15,000+ business visitors from manufacturing, retail, healthcare, finance
- Pre-scheduled B2B meetings
- Multi-industry exposure
- Live product demonstration opportunities

### For Fintech Companies
TEG connects fintech companies with banking, finance, and insurance sector decision-makers. Benefits include:
- Access to finance industry leaders
- Networking with investors
- Association with Gujarat's growing fintech ecosystem

### For Cloud & Infrastructure Companies
Cloud providers benefit from:
- Direct access to IT decision-makers
- Demonstration of cloud solutions to 15,000+ visitors
- Networking with enterprise buyers

---

## Source Citations

- **Company websites:** Extracted from techexpogujarat.com/exhibitors and verified via individual company pages
- **Podcast citations:** "Chai Time with ManthanBaba" (YouTube) — ~49 episodes with named founders for ~40 companies
- **Official sectors:** techexpogujarat.com/industries/
- **TEG 2026 confirmed exhibitors:** techexpogujarat.com, eternalsoftsolutions.com, technobrains.io, perigeon.com
