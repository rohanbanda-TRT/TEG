# Registration, Tickets & Passes — TEG 2026
...
*Internal process guide — a synthesized walkthrough of the typical visitor flow, not verbatim text from the official site.*

1. **Register online** — Complete the registration form on the ticketing portal.
2. **Receive confirmation** — Get event instructions, QR code, and schedule via email.
3. **Review exhibitors and sessions** — Browse the exhibitor directory and session agenda before the event.
4. **Select companies or topics of interest** — Plan your visit by shortlisting booths and sessions.
5. **Attend the event** — Arrive at the venue and check in using your QR code.
6. **Visit booths and demonstrations** — Engage with exhibitors, watch demos, and collect information.
7. **Join talks and networking** — Attend keynote sessions, panel discussions, and networking meetups.

*Note: steps 3–4 (browsable exhibitor directory, published session agenda) assume information that isn't fully live yet for TEG 2026 — see `exhibitors/exhibitors_directory.md` and `speakers/speakers_and_agenda.md` for current status.*

---

## How to register
- **Visitor tickets:** Book via the ticketing portal — https://events.techexpogujarat.com/e/6946415bbc05410ef59021d7 ("Book Your Ticket" / "Get Ticket")
- **Exhibitor booking ("Book Your Stall"):** https://www.techexpogujarat.com/become-an-exhibitor/
...
- SMEs & MSMEs looking to discover AI and advanced tech solutions
- Entrepreneurs wanting to learn about emerging tech, networking, and keynotes
- Investors & VCs scouting investable startups and technologies
...
## Legal/policy pages (on the ticketing portal)
- Terms & Conditions: https://www.techexpogujarat.com/terms-conditions
- Privacy Policy: https://www.techexpogujarat.com/privacy-policy
- Refund Policy: https://www.techexpogujarat.com/refund-policy

---

## For comparison: TEG Business Retreat 2025 ticket tiers (invite-only, now sold out)
All tiers were sold out at last check, and included accommodation, meals, and networking (twin-sharing room + Ahmedabad pickup/drop):

| Tier | Price | Includes |
|---|---|---|
| Founder Pitch Pass | ₹7,500 | Focused pitch slot, round table with investors, lunch |
| Standard | ₹30,000 | Standard accommodation, seating, networking sessions, all meals |
| Premium | ₹40,000 | Premium accommodation, front-line seating, networking, all meals |
| VIP | ₹50,000 | Premium accommodation, first-row seating, round-table discussions, meals with VIPs/guests |
