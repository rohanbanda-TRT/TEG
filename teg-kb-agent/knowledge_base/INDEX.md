...
│
├── digital_presence/
│   └── digital_channels.md                            ← Official channels, site structure, vendors
│
└── faq/
...
- **Comparable/adjacent Gujarat tech events noted for context** (not TEG-affiliated), independently re-verified: EFY Expo Gujarat 2026 (Dec 2026, Gandhinagar, electronics-focused, organized by EFY — no TEG/AIMED mention found) and TECH VAPI 2026 (Dec 2026, Vapi, organized by SOFTWEB — no TEG/AIMED mention found). See `digital_presence/digital_channels.md`.
